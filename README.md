...
## Datasets:
KITTI: Download the dataset (grayscale images) from [here(http://www.cvlibs.net/datasets/kitti/eval_odometry.php)] (here) and prepare the KITTI folder as specified above
## Training:
```python
train.py
```
